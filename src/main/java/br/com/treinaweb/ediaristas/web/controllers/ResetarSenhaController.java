...
public class ResetarSenhaController {
    ...
    public String resetarSenha(@ModelAttribute ResetarSenhaForm form, RedirectAttributes attrs) {
        service.solicitarResetSenha(form);
        attrs.addFlashAttribute("alert",
                new FlashMessage("alert-success", "Verifique o seu e-mail para ter acesso ao link de reset de senha"));
    ...
    public String confirmacaoResetSenha(@ModelAttribute("form") @Valid ResetarSenhaConfirmacaoForm form,
            BindingResult result, @RequestParam String token) {
        try {
