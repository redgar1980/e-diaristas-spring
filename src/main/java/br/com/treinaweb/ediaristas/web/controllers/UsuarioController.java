...
public class UsuarioController {
    ...
    public String cadastrar(@Valid @ModelAttribute("cadastroForm") UsuarioCadastroForm cadastroForm, 
            ...
            attrs.addFlashAttribute("alert", new  FlashMessage("alert-sucess", "Usuário cadastrado com sucesso!"));
    ...
    public String excluir(@PathVariable Long id, RedirectAttributes attrs) {
        ...
        attrs.addFlashAttribute("alert", new FlashMessage("alert-sucess", "Usuário excluido com sucesso!"));
