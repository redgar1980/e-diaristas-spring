...
@Component
public class DiariaCancelamentoValidador {
    ...
    private void validarDataAtendimento(Diaria diaria) {
        ...
        if (isDataAtendimentoNoPassado) {
            var mensagem = "Não é mais possível cancelar a diária.";
            var fieldError = new FieldError(diaria.getClass().getName(), "dataAtendimento", diaria.getDataAtendimento(),
